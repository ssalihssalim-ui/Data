...
function showView(viewId) {
    ...
    // Mise à jour des liens du sidebar
    ...
    // Fermer le sidebar après navigation
    closeSidebar();
}

// Gestion des clics sur les liens de navigation (header et sidebar)
...
// Fermer le sidebar si on clique sur un lien
sidebarLinks.forEach(link => {
...
// ============================================================
// 8. AFFICHAGE DES PRODUITS (Firestore + fallback)
// ============================================================
